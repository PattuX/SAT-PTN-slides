...
\begin{frame}{Cube-and-conquer solving}
	...
	\begin{figure}
		...
		\node(look-ahead2) at ($(look-ahead1) + (0, -2)$){look-ahead};
		\node[text = mdwblue, align = center](3450) at ($(look-ahead2) + (-1, -0.75)$){3450 unassigned\\ variables};
		\node(CDCL) at ($(look-ahead2) + (0, -1.5)$){CDCL};
